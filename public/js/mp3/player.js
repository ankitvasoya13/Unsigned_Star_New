...
jQuery(document).ready(function (a) {
    ...
    (adonisPlayer.init = function () {
        ...
        (adonisPlaylist = new adonisJPlayerPlaylist(
            ...
            [{ title: "----", artist: "----", mp3: "", poster: "/js/mp3/browse/browse-overview-4.jpg" }],
            ...
            a("#" + adonisPlayerID).bind(a.jPlayer.event.play + ".jp-repeat", function (e) {
                ...
                r.name ? a("#" + adonisPlayerContainer + " .artist-name").html(r.name) : a("#" + adonisPlayerContainer + " .artist-name").html(r.name),
