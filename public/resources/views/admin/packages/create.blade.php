...
<section class="content">
  <form class="form-horizontal" method="post" action="{{ url('/admin/packages/add') }}" novalidate="novalidate" enctype="multipart/form-data">{{ csrf_field() }}
    <div class="row">
      <div class="col-md-12">
        <div class="card card-secondary">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" name="price" id="inputName" class="form-control" value="">
            </div>
            <div class="form-group">
              <label for="inputName">No of Track</label>
              <input type="text" name="track_limit" id="inputName" class="form-control" value="">
            </div>
          </div>
          <!-- /.card-body -->
        </div>
