			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="indx_title_left_wrapper ms_cover">
					...
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item">Fans</li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 p-0">
				<ul class="nav nav-tabs text-center" id="myTab" role="tablist">
					<li class="nav-item col-xl-6"> <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"><i class="flaticon-vinyl"></i> Fan Details</a> </li>
					...
					<div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
						...
						<form>
							<div class="col-lg-12 col-md-12">
								<div class="form-pos">
									<div class="form-group i-name">
										<input type="password" onfocusout="comparePassword()" id="password" class="form-control require" name="old_password" required="" placeholder="Old Password *">
									</div>
								</div>
							</div>
							<div class="col-lg-12 col-md-12">
								<div class="form-pos">
									<div class="form-group i-name">
										<input type="password" onfocusout="comparePassword()" id="confirm_password" class="form-control require" name="new_password" required="" placeholder="New Password *">
