	...
	<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
		<div class="carousel-inner" role="listbox">
					...
					<div class="container jn_container">
						<div class="row align-items-center">
							<div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-12 pr-0">
								<div class="content">
									<h1 data-animation="animated fadeInUp">{{ $slider->heading_1 }}</h1>
									<h2 data-animation="animated fadeInUp">{{ $slider->heading_2 }}</h2>
									<p data-animation="animated fadeInUp">{{ strip_tags($slider->description) }}</p>
									<div class="slider_btn ms_cover">
										<div class="lang_apply_btn">
											<ul>
												<li data-animation="animated fadeInUp">
													<a href="{{ $slider->button_url }}"> <i class="flaticon-play-button"></i>browse</a>
												</li>
											</ul>
							...
							<div class="col-xl-9 col-lg-9 col-md-8 col-sm-12 col-12 px-0">
								<div class="content_img_wrapper">
									<img src="{{ asset('uploads/'.$slider->slider_image) }}" alt="img">
								</div>
							</div>
			...
			<ol class="carousel-indicators">
				@foreach($sliders as $i => $slider)
				<li data-target="#carousel-example-generic" data-slide-to="{{ $i }}" class="@if($i==0) active @endif"><span class="number"></span>
				</li>
				@endforeach
			</ol>
	...
	<div class="container">
		<div class="row text-center">
			<div class="col-lg-3 col-md-12 col-sm-12 col-12 p-2">
				<div class="music-artist-search bg-white p-4 music_blog">
					<h5>Artist Search</h5>
					<br>
					<select name="country" id="artistCountry" class="col-lg-12 col-md-12 col-sm-12 col-12">
					...
					<br><br>
					<select name="genres" id="artistGenres" class="col-lg-12 col-md-12 col-sm-12 col-12">
			...
			<div class="col-lg-3 col-md-12 col-sm-12 col-12 p-2 desktop">
				<div class="bg-white music_blog">
					...
					<div class="event_single_slider">
						<div class="owl-carousel owl-theme">
							@foreach($panelUsers as $panel)
							<div class="item">
								<a href="{{ url('/profile/'.$panel->id) }}">
									@if(!empty($panel->profile_image))
									<img src="{{ asset('/uploads/'.$panel->profile_image) }}" alt="blog_img">
									@else
									<img src="{{ asset('images/blog1.png') }}" alt="blog_img">
									@endif
								</a>
							</div>
							@endforeach
			...
			<div class="col-lg-3 col-md-12 col-sm-12 col-12 p-2 desktop">
				<div class="bg-white music_blog">
					<div class="music-artist-search bg-white p-2">
						<h5>Success Story</h5>
					</div>
					@foreach($storyDetails as $story)
					<a href="{{ url('/success-stories/storyDetails/'.$story->id) }}"><img src="{{ asset('/uploads/'.$story->featured_image) }}" class="img-responsive" width="269px"></a>
					@endforeach
				</div>
			</div>
			<div class="col-lg-3 col-md-12 col-sm-12 col-12 p-2 desktop">
				<div class="bg-white music_blog">
					<div class="music-artist-search p-2">
						<h5>Feature Artists</h5>
					</div>
					@foreach($featuredArtists as $featuredArtist)
					<a href="{{ url('/profile/'.$featuredArtist->id) }}"><img src="{{ asset('/uploads/'.$featuredArtist->profile_image) }}" class="img-responsive" width="225px"></a>
					@endforeach
				</div>
			</div>
		</div>
		...
		<div class="row text-center" id="searchResult">
			...
			<div class="col-lg-3 col-md-6 col-sm-12 col-12">
				<div class="feature_artist_image text-center py-4">
					<img src="{{ asset('/uploads/'.$artistUser->profile_image) }}" class="img-responsive" alt="img" width="225px">
				</div>
				<h6>{{ $artistUser->first_name.' '.$artistUser->last_name }}</h6>
			</div>
			@endforeach --}}
		</div>
	</div>
						...
						<div class="top_songs_list_left">
							<div class="treanding_slider_main_box top_lis_left_content">
								<div class="top_songs_list0img">
									<img src="uploads/tracks/imgs/{{ $song->cover_image }}" onerror="this.src='images/album.png'" alt="img" width="50px" height="50px">
									<div class="ms_treanding_box_overlay">
										<div class="ms_tranding_box_overlay"></div>

										<div class="tranding_play_icon">
											{{-- <a href="#"> --}}
												<i class="flaticon-play-button" onclick="playSong('{{ $song->track_name }}','{{ $song->first_name.' '.$song->last_name }}','uploads/tracks/{{ $song->track_file }}','uploads/tracks/imgs/{{ $song->cover_image }}','{{ $song->id }}')"></i>
											{{-- </a> --}}
										</div>
									</div>
								</div>
						...
						<div class="top_songs_list_right">
							...
							<div class="top_song_list_picks">
								...
								<ul class="tranding_more_option">
									<li onclick="addPlayList('{{ $song->track_name }}','{{ $song->first_name.' '.$song->last_name }}','uploads/tracks/{{ $song->track_file }}','{{ $song->cover_image }}','{{ $song->id }}')"><a><span class="opt_icon"><i class="flaticon-playlist"></i></span>Add To playlist</a></li>
						...
						<?php
							...
							foreach($sliderArtists as $sliderArtist) {
								...
								<div class="featured_artist_list ms_cover">
									<img src="{{ asset('/uploads/'.$sliderArtist->profile_image) }}" class="img-responsive" alt="img">
									<div class="featured_artist_detail">
										<p><a href="{{ url('/profile/'.$sliderArtist->id) }}">{{ $sliderArtist->first_name.' '.$sliderArtist->last_name }}</a></p>
									</div>
								</div>
								<?php
