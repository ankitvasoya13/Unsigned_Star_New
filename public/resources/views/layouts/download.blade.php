		...
		<div class="row">
			<div class="col-lg-6 col-md-12 col-sm-12 col-12">
				<div class="download_app_store ms_cover">
					...
					<div class="app_btn ms_cover"> <a href="#">get the app now</a> </div>
			...
			<div class="col-lg-6 col-md-12 col-sm-12 col-12">
				<div class="download_mockup_design ms_cover"> <img src="{{ asset('images/mockup.png') }}" class="img-responsive" alt="img"> </div>
			</div>
		</div>
	</div>
</div>