					...
					<form class="form-horizontal" id="loginForm">
						...
						<div class="login_form_wrapper">
							...
							<div class="icon_form comments_form">
								...
								@if ($errors->has('email')) <span class="help-block"> <strong>{{ $errors->first('email') }}</strong> </span> @endif <i class="fas fa-envelope"></i> 
							</div>
							<div class="icon_form comments_form">
								<input type="password" name="password" class="form-control" placeholder="Enter Password *">
								@if ($errors->has('password')) <span class="help-block"> <strong>{{ $errors->first('password') }}</strong> </span> @endif <i class="fas fa-lock"></i> 
							</div>
						...
						<div class="lang_apply_btn_wrapper ms_cover">
							{{-- <div class="lang_apply_btn"> <a href="#" id="loginNow">login now</a> </div> --}}
							...
							<div class="dont_have_account ms_cover">
								<p>Don’t have an account ? 
									...
									<a href="{{ url('/join') }}">register here</a> </p>
							</div>
						</div>
						</div>
					</form>
					...
					<form class="form-horizontal" id="forgotForm" autocomplete="off">
						...
						<div class="login_form_wrapper">
							...
							<div class="icon_form comments_form">
								...
								@if ($errors->has('email')) <span class="help-block"> <strong>{{ $errors->first('email') }}</strong>
								</span> @endif <i class="fas fa-envelope"></i> 
							</div>
							<div class="login_remember_box">								
