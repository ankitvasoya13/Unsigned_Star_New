...
<section class="content">
  <form class="form-horizontal" method="post" action="{{ url('/admin/coupons/edit/'.$coupon->id) }}" novalidate="novalidate" enctype="multipart/form-data">{{ csrf_field() }}
    <div class="row">
      <div class="col-md-12">
        <div class="card card-secondary">
          ...
          <div class="card-body">
            ...
            <input type="text" name="coupon_code" id="inputName" class="form-control" value="{{$coupon->coupon_code}}" >
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <select name="type" class="form-control">
                <option value="FLATE" {{($coupon->type == 'FLATE') ? 'selected':''}}>FLATE</option>
            ...
            <div class="form-group">
              ...
              <input type="text" name="amount" id="inputName" class="form-control" value="{{$coupon->amount}}">
            </div>
            <div class="form-group">
              <label for="inputName">Discount Type</label>
              <select name="status" class="form-control">
                {{-- <option value="{{$coupon->status}}">{{($coupon->status == '1') ? 'ACTIVE':'INACTIVE'}}</option> --}}
            ...
            <div class="form-group">
              ...
              <input type="text" name="expiry_date" id="inputName" class="form-control" value="{{$coupon->expiry_date}}" placeholder="2021-01-31">
            </div>
          </div>
