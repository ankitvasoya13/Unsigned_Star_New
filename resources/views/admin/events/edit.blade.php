          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <input type="textarea" name="short_description" id="short_description" class="form-control" value="{{ $eventDetails->short_description }}" required="" />
              </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <p ><img class="featured_image_preview" src="{{ asset('/uploads/'.$eventDetails->featured_image) }}" alt="preview image"></p>
                    </div>
