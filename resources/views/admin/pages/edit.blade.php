...
<section class="content">
  <form class="form-horizontal" method="post" action="{{ url('/admin/pages/edit/'.$pageDetails->id) }}"
        ...
        <div class="card card-secondary">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <textarea class="textarea" name="content" required="">{{ $pageDetails->content }}</textarea>
            </div>
            <div class="form-group">
              ...
              <div id="uploaded_image" style="padding-top: 20px;">
                <p>
                  <img id="featured_image_preview" src="{{ asset('/uploads/'.$pageDetails->featured_image) }}" alt="preview image"
