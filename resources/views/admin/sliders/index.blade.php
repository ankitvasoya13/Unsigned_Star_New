              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{ $slider->heading_2 }}</td>
					        <td class="center"> 
                    <a href="{{ url('/admin/sliders/edit/'.$slider->id) }}" class="btn btn-primary btn-mini">Edit</a> 
                    <a href="{{ url('/admin/sliders/delete/'.$slider->id) }}" class="btn btn-danger btn-mini">Delete</a>
                  </td>
                </tr>
                @endforeach
                </tbody>
