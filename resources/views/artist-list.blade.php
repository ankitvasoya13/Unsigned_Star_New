                    ...
                    <div class="blog_category_box_wrapper blog_box_wrapper2 float_left">
                         <div class="blog_news_img_wrapper float_left">
                             @if(!empty($artistUser->profile_image))
                                   <a href="{{ url('/profile/'.$artistUser->id) }}"><img src="{{ asset('/uploads/'.$artistUser->profile_image) }}" alt="img" class="w-100"></a>
                              @else
                                   <a href="{{ url('/profile/'.$artistUser->id) }}"><img src="{{ asset('images/ft3.jpg') }}" alt="img" class="w-100"></a>
                              @endif
                         </div>
                         <div class="lest_news_cont_wrapper float_left">
                              <div class="blog_heaidng_top">
                                   <h3> <a href="{{ url('/profile/'.$artistUser->id) }}">{{ $artistUser->first_name.' '.$artistUser->last_name }}</a></h3>
                              </div>
