					...
					<div class="container jn_container">
						<div class="row align-items-center">
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 p-0">
								<img src="{{ asset('images/main-banner.jpg') }}" alt="blog_img" class="w-100">
							</div>
		...
		<div class="row text-center">
				...
				<div class="bg-white music_blog">
					...
					<div class="event_single_slider">
						<div class="owl-carousel owl-theme">
							...
							<div class="item">
								<a href="{{ url('/profile/'.$panel->id.'/'.$panel->first_name . '-' . $panel->last_name) }}">
			...
			<div class="col-lg-3 col-md-6 col-sm-12 col-12 p-2 desktop">
				<div class="bg-white music_blog">
					...
					@foreach($competitionDetails as $competition)
					<a href="{{ url('/competitions/competitionDetails/'.$competition->id) }}"><img src="{{ asset('/uploads/'.$competition->featured_image) }}" class="img-responsive" width="269px"></a>
					@endforeach
				</div>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-12 col-12 p-2 desktop">
						...
						<div class="top_songs_list_left">
							<div class="treanding_slider_main_box top_lis_left_content">
								<div class="top_songs_list0img">
									<img src="{{url('uploads/tracks/imgs/'.$song->cover_image)}}" onerror="this.src='images/album.png'" alt="img" width="50px" height="50px">
									<div class="ms_treanding_box_overlay">
										<div class="ms_tranding_box_overlay"></div>

										<div class="tranding_play_icon">
											{{-- <a href="#"> --}}
												<i class="flaticon-play-button" onclick="playSong('{{ $song->track_name }}',' {{ $song->first_name.' '.$song->last_name }}','uploads/tracks/{{ $song->track_file }}','{{url('uploads/tracks/imgs/'.$song->cover_image)}}','{{ $song->id }}')"></i>
											{{-- </a> --}}
										</div>
									</div>
								</div>
						...
						<div class="top_songs_list_right">
							...
							<div class="top_song_list_picks">
								...
								<ul class="tranding_more_option">
									<li onclick="addPlayList('{{ $song->track_name }}','{{ $song->first_name.' '.$song->last_name }}','uploads/tracks/{{ $song->track_file }}','{{url('uploads/tracks/imgs/'.$song->cover_image)}}', '{{ $song->id }}')"><a><span class="opt_icon"><i class="flaticon-playlist"></i></span>Add To playlist</a></li>
						...
						<?php
							...
							foreach($sliderArtists as $sliderArtist) {
								...
								<div class="featured_artist_list ms_cover">
									<a href="{{ url('/profile/'.$sliderArtist->id.'/'.$sliderArtist->first_name . '-' . $sliderArtist->last_name) }}"><img src="{{ asset('/uploads/'.$sliderArtist->profile_image) }}" class="img-responsive" alt="img"></a>
									<div class="featured_artist_detail">
										<p><a href="{{ url('/profile/'.$sliderArtist->id.'/'.$sliderArtist->first_name . '-' . $sliderArtist->last_name) }}">{{ $sliderArtist->first_name.' '.$sliderArtist->last_name }}</a></p>
									</div>
								</div>
								<?php
