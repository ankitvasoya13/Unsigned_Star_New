...
<div id="sidebar" class="bounce-to-right">
    ...
    <div id='cssmenu'>
        ...
        <ul class="sidebb">
            ...
            <li><a href="{{ url('top-songs') }}"><i class="flaticon-info"></i>Top Songs</a></li>
            <li><a href="{{ url('success-stories') }}"><i class="flaticon-playlist-1"></i>Success Stories</a></li>
            <li><a href="{{ url('our-panel') }}"><i class="flaticon-clock"></i>Our Panel</a></li>
            <li><a href="{{ url('competitions') }}"><i class="flaticon-playlist"></i>Competitions</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="m24_header_right_Wrapper d-none d-sm-none d-md-none d-lg-none d-xl-block">
            <div class="m24_signin_wrapper show-on-hover">
                @if(Session::has('userSession'))
                    <a> 
                        ...
                        <img src="{{ asset('uploads/'.Session::get('profileImg')) }}" onerror="this.onerror=null;this.src='uploads/avatar.png';">                        
                        @else
                    ...
                    <ul class="navi_2_dropdown1 dropdown-menu" role="menu" style="right: 0 !important; left:unset;">
                        <li class="parent1">
                            <a href="{{ url('/profile/'.Session::get('userId')) }}">Profile</a>
                        </li>
                        <li class="parent1">
                ...
                @else
                    <a href="#" data-toggle="modal" data-target="#login_modal">
                        <img src="{{ asset('images/pf.png') }}" alt="img"><div class="login_top_wrapper">
                            <p>login/register</p>
            ...
            <div class="crm_message_dropbox_wrapper">
                <div class="budge_noti_wrapper"><a href="{{ url('message') }}">
