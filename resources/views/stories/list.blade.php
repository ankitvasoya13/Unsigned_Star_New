    ...
    <div class="blog_category_box_wrapper blog_box_wrapper2 float_left">
        ...
        <div class="lest_news_cont_wrapper float_left">
            <div class="blog_heaidng_top">
                ...
                <h3> <a href="{{ url('/success-stories/storyDetails/'.$story->id) }}">
                        {!!mb_substr(html_entity_decode($story->title),0,20) .
                    ((strlen(html_entity_decode($story->title)) > 20) ? '...' : '')!!}
                    </a></h3>
            </div>

            <div class="blog-single_cntnt"> {!!mb_substr(html_entity_decode($story->short_description),0,25) .
