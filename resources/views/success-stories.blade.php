			...
			<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
				<div class="blog_category_box_wrapper blog_box_wrapper2 float_left">
					<div class="blog_news_img_wrapper float_left">
						<a href="{{ url('/success-stories/storyDetails/'.$story->id) }}"><img src="{{ asset('/uploads/'.$story->featured_image) }}" ></a>
					</div>
					<div class="lest_news_cont_wrapper float_left">
						...
						<div class="blog-single_cntnt"> {!!mb_substr(html_entity_decode($story->description),0,60) . ((strlen(html_entity_decode($story->description)) > 60) ? '...' : '')!!} <a href="{{ url('/success-stories/storyDetails/'.$story->id) }}"> read more</a> </div>
