			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="artist_wrapper_content ms_cover">
					<div class="artist_wrapper_left profile-contain">
						...
						<p><i class="fa fa-angle-right second_icon"></i> Browse & listen to Unsigned Artists Worldwide</p>
						<ul>
							...
							<li>Competitions</li>
							<li>Comment on Artists Profile</li>
							<li>Send message to Artists and Fans</li>
						</ul>
					</div>
				</div>
			</div>
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="tab-content" id="myTabContent">
					<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
						...
						<?php endif; ?>
						<form class="form-horizontal" method="post" action="<?php echo e(url('/panel-signup')); ?>" id="registerForm" enctype="multipart/form-data">
