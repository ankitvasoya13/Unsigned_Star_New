...
<section class="content">
  <form class="form-horizontal" method="post" action="<?php echo e(url('/admin/events/add')); ?>" enctype="multipart/form-data"><?php echo e(csrf_field()); ?>
        ...
        <div class="card card-secondary">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <p id="imagePreviewWidth">
                  <img class="featured_image_preview" src="<?php echo e(asset('/images/blank.jpg')); ?>" alt="preview image">
              </p>
                </div>
