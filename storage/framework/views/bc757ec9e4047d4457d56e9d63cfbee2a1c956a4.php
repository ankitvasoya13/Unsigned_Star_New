...
<section class="content">
  <form class="form-horizontal" method="post" action="<?php echo e(url('/admin/stories/add')); ?>" enctype="multipart/form-data"><?php echo e(csrf_field()); ?>
            ...
            <div class="form-group">
              ...
              <div class="custom-file">
                ...
                <div id="uploaded_image" style="padding-top: 20px;">
                    <p>
                    <img id="featured_image_preview" class="featured_image_preview" src="<?php echo e(asset('/images/blank.jpg')); ?>" alt="preview image" >
                    </p>
               </div>
