        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 col-12 my-lg-0 my-md-0 my-sm-0 my-2">
                    ...
                    <div class="form-group m-0">
                        ...
                        <i class="fa fa-search search-icon" style="right: 16px" onclick="searchArtist(8)"></i>
                    ...
                    <div class="blog_category_box_wrapper blog_box_wrapper2 float_left">
                         <div class="blog_news_img_wrapper float_left">
                             <?php if(!empty($artistUser->profile_image)): ?>
                                   <a href="<?php echo e(url('/profile/'.$artistUser->id)); ?>"><img src="<?php echo e(asset('/uploads/'.$artistUser->profile_image)); ?>" alt="img" class="w-100"></a>
                              <?php else: ?>
                                   <a href="<?php echo e(url('/profile/'.$artistUser->id)); ?>"><img src="<?php echo e(asset('images/ft3.jpg')); ?>" alt="img" class="w-100"></a>
                              <?php endif; ?>
                         </div>
                         <div class="lest_news_cont_wrapper float_left">
                              <div class="blog_heaidng_top">
                                   <h3> <a href="<?php echo e(url('/profile/'.$artistUser->id)); ?>"><?php echo e($artistUser->first_name.' '.$artistUser->last_name); ?></a></h3>
                              </div>
