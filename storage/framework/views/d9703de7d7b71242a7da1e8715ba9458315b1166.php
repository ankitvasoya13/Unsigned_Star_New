...
<section class="content">
  <form class="form-horizontal" method="post" action="<?php echo e(url('/admin/sliders/add')); ?>" novalidate="novalidate" enctype="multipart/form-data"><?php echo e(csrf_field()); ?>
        ...
        <div class="card card-secondary">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <p><img id="featured_image_preview" src="<?php echo e(asset('/images/blank.jpg')); ?>" alt="preview image" style="max-height: 150px;"></p>
