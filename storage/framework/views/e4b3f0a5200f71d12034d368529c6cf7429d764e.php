...
<section class="content">
  <form class="form-horizontal" method="post" action="<?php echo e(url('/admin/panels/edit/'.$userDetails->id)); ?>" enctype="multipart/form-data">
                ...
                <div class="col-lg-6 col-md-6" style="display: none;">
                  <div class="form-s">
                    ...
                    <div class="form-group i-dob">
                      <input type="text" class="form-control require" name="birthdate" placeholder="Date of Birth *" onfocus="(this.type='date')" value="<?php echo e($birthdate); ?>">
                    </div>
                  </div>
                </div>
              ...
              <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                <div id="uploaded_image" style="padding-top: 20px;">
                    <p>
                      <?php if(!empty($userDetails->profile_image) || $userDetails->profile_image != '' || $userDetails->profile_image != Null): ?>
                      <img id="featured_image_preview" src="<?php echo e(asset('/uploads/'.$userDetails->profile_image)); ?>" alt="preview image" style="max-height: 150px;">
                       <?php else: ?>
                        <img id="featured_image_preview" src="<?php echo e(asset('/images/blank.jpg')); ?>" alt="preview image"
