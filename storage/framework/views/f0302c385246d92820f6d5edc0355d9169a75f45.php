...
<section class="content">
  <form class="form-horizontal" method="post" action="<?php echo e(url('/admin/competitions/add')); ?>" enctype="multipart/form-data"><?php echo e(csrf_field()); ?>
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <div class="custom-file">
                ...
                <p><img id="competition_create_image_preview" class="featured_image_preview" src="<?php echo e(asset('/images/blank.jpg')); ?>" alt="preview image"></p>
                    </div>
